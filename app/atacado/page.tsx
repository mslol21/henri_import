...
export const metadata = {
  title: 'Portal do Atacado B2B | Henri Imports',
  description: 'Catálogo de produtos com preços especiais de atacado para revendedores.',
};
...
export default async function WholesalePage() {
  ...
  // If authenticated as Wholesale User, render full B2B Wholesale Catalog
  if (isWholesale) {
    ...
    return (
      <WholesaleCatalog
        ...
        storeName={config?.name || 'Henri Imports'}
      />
    );
  }

  // Otherwise, render Wholesale Login Portal
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white border border-slate-200 rounded-3xl p-8 shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black uppercase tracking-tight text-slate-900">Portal do Atacado B2B</h1>
